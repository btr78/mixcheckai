...
import { ClerkProvider, SignInButton, SignedIn, SignedOut, UserButton, useUser, useAuth } from "@clerk/clerk-react";
...
function AIChatPage({ isPro, onUnlockClick, user }) {
  ...
  var send = async function() {
    ...
    try {
      var token = null;
      try { token = auth.getToken ? await auth.getToken() : null; } catch (e) {}
...
var CHEAT_FREE = {
    ...
    "peq": [
      {
        ...
        "action": "Cut 2-4 dB",
        "q": "Medium (1.0-1.5)",
        "reason": "Remove boxy chest resonance. Sweep to find the exact frequency on your singer."
      },
      {
        "band": "Mud Zone",
        "freq": "350-500 Hz",
        "action": "Cut 1-3 dB",
        "q": "Medium-Wide (0.7-1.0)",
        "reason": "Clean up muddiness, especially in smaller rooms or with close mic technique."
      }
    ],
    "peqTotal": 4
  },
    ...
    "peq": [
      {
        ...
        "action": "Cut 3-5 dB",
        "q": "Medium (1.0)",
        "reason": "BG vocals must be thinner than lead. Aggressive low-mid cut keeps them from competing."
      },
      {
        "band": "Presence",
        "freq": "3-5 kHz",
        "action": "Cut 1-2 dB",
        "q": "Medium (0.8)",
        "reason": "Roll off presence slightly so BG vocals sit behind the lead. They should support, not compete."
      }
    ],
    "peqTotal": 3
  },
    ...
    "peq": [
      {
        "band": "Kick - Punch",
        "freq": "60-100 Hz",
        "action": "Boost 2-4 dB on kick channel",
        "q": "Medium (1.2)",
        "reason": "The fundamental thump of the kick. Sweep between 60-100 Hz to find the room resonance of the drum."
      },
      {
        "band": "Kick - Attack",
        "freq": "3-5 kHz",
        "action": "Boost 1-3 dB on kick channel",
        "q": "Medium (1.0)",
        "reason": "Beater click and attack. Essential for kick to cut through on stream where low end is often lost on small speakers."
      }
    ],
    "peqTotal": 5
  },
    ...
    "peq": [
      {
        ...
        "action": "Cut 2-4 dB",
        "q": "Medium (1.0-1.2)",
        "reason": "The main problem zone for acoustic guitar. Where boxy, muddy tone lives. Sweep slowly to find the worst frequency."
      },
      {
        "band": "Body Warmth",
        "freq": "100-150 Hz",
        ...
        "q": "Wide (0.6-0.8)",
        "reason": "If the guitar sounds too thin or hollow after the low-mid cut, a gentle boost here restores warmth."
      }
    ],
    "peqTotal": 4
  },
  "bass": {
    ...
    "peq": [
      {
        "band": "Sub Fundamental",
        "freq": "60-80 Hz",
        "action": "Boost 1-3 dB",
        "q": "Medium (1.0-1.2)",
        "reason": "The core fundamental of the bass. Gives weight and power. Find the fundamental note of the open E or B string."
      },
      {
        "band": "Low Mid Mud",
        "freq": "200-400 Hz",
        "action": "Cut 2-4 dB",
        "q": "Medium (1.0)",
        "reason": "Where bass gets muddy and interferes with kick drum and vocals. A cut here cleans up the whole mix."
      }
    ],
    "peqTotal": 4
  },
    ...
    "peq": [
      {
        ...
        "action": "Cut 2-4 dB",
        "q": "Medium (1.0)",
        "reason": "Where electric guitar sounds boxy and interferes with bass and kick. Cut more on high-gain tones."
      },
      {
        "band": "Mid Honk",
        "freq": "400-600 Hz",
        "action": "Cut 1-3 dB",
        "q": "Medium (1.2)",
        "reason": "The nasal honky midrange of electric guitar. Reduces the harsh, forward tone that fatigues listeners on stream."
      }
    ],
    "peqTotal": 4
  },
    ...
    "peq": [
      {
        ...
        "action": "Cut 3-5 dB",
        "q": "Medium (1.0-1.2)",
        "reason": "Rhythm guitar must give way to bass and kick. A firm low-mid cut creates separation and clarity."
      },
      {
        "band": "Upper Mid Body",
        "freq": "800-1200 Hz",
        "action": "Boost 1-2 dB",
        "q": "Medium (0.8)",
        "reason": "Adds body and fullness to chord strums without adding mud. The rhythm guitar presence zone."
      }
    ],
    "peqTotal": 4
  },
  "pad": {
    ...
    "peq": [
      {
        "band": "Low End Control",
        "freq": "150-300 Hz",
        "action": "Cut 4-6 dB",
        "q": "Wide (0.6)",
        "reason": "Pads often have excessive low-mid content that muddles the mix. This is the most important cut for pads."
      },
      {
        "band": "Mid Transparency",
        "freq": "500-800 Hz",
        "action": "Cut 1-3 dB",
        "q": "Wide (0.7)",
        "reason": "Pads in this range interfere with vocals. A gentle cut keeps pads transparent and supportive."
      }
    ],
    "peqTotal": 3
  },
    ...
    "peq": [
      {
        ...
        "action": "Cut 2-4 dB",
        "q": "Medium (1.0)",
        "reason": "The main problem zone for piano on stream. Where the piano sounds boxy and interferes with vocals and guitar."
      },
      {
        "band": "Mid Presence",
        "freq": "1-2 kHz",
        "action": "Boost 1-2 dB",
        "q": "Medium (0.8)",
        "reason": "Note definition and clarity. Helps the piano melody cut through the mix without adding harshness."
      }
    ],
    "peqTotal": 4
  },
    ...
    "peq": [
      {
        "band": "Sub Control",
        "freq": "40-80 Hz",
        "action": "Gentle high-pass, not a hard cut",
        "q": "Gentle slope",
        "reason": "Grand piano has real sub-bass energy. A very gentle HPF is better than a hard cut. Preserve the bass register."
      },
      {
        "band": "Low Mid Shape",
        "freq": "200-400 Hz",
        "action": "Cut 1-3 dB",
        "q": "Wide (0.6)",
        "reason": "Reduce muddiness without destroying the warmth that makes a grand piano special."
      }
    ],
    "peqTotal": 4
  },
    ...
    "peq": [
      {
        ...
        "action": "Boost 2-4 dB",
        "q": "Medium (1.2)",
        "reason": "Electronic kick often lacks the sub-bass punch of acoustic. A boost here adds the weight and thump."
      },
      {
        "band": "Kick Click",
        "freq": "3-5 kHz",
        "action": "Boost 2-3 dB",
        "q": "Medium (1.0)",
        "reason": "Beater click for definition on small speakers and stream playback where low end disappears."
      }
    ],
    "peqTotal": 4
  }
...
function getCheatSheet(instrument, mixer) {
  // Free teaser only. Pro content (extra EQ bands, compression, GEQ, effects,
  // stream tips) is fetched from /api/check-pro?resource=cheatsheet after a
  // server-side Pro entitlement check — it is NOT in this bundle.
  var id = instrument && instrument.id;
  return CHEAT_FREE[id] || CHEAT_FREE.el_drums;
}
...
function CheatSheetPage({ mixer, instrument, isPro, onUnlockClick, onReset }) {
  var auth = useAuth();
  var freeData = getCheatSheet(instrument, mixer);
  var isDigital = getMixerType(mixer) !== "analog";
  var freePeqLimit = 2; // Free users see first 2 PEQ bands only

  // Pro cheat-sheet content is NOT in the bundle — fetch it after a server-side
  // Pro entitlement check. Free users only ever have the teaser (hpf + 2 bands).
  var proState = useState(null); var proData = proState[0]; var setProData = proState[1];
  var proErrState = useState(false); var proError = proErrState[0]; var setProError = proErrState[1];
  var reloadState = useState(0); var reloadTick = reloadState[0]; var setReloadTick = reloadState[1];

  useEffect(function() {
    setProData(null); setProError(false);
    if (!isPro) return;
    var cancelled = false;
    (async function() {
      try {
        ...
        var qs = "resource=cheatsheet&instrument=" + encodeURIComponent(instrument.id);
        if (auth.userId) qs += "&userId=" + encodeURIComponent(auth.userId);
        qs += "&deviceId=" + encodeURIComponent(getDeviceId());
        var r = await fetch("/api/check-pro?" + qs, { headers: headers });
        var d = await r.json().catch(function () { return {}; });
        if (cancelled) return;
        if (r.ok && d && d.pro) setProData(d); else setProError(true);
      } catch (e) { if (!cancelled) setProError(true); }
    })();
    return function() { cancelled = true; };
  }, [isPro, instrument.id, reloadTick]);

  // Merge the fetched Pro content over the free teaser for Pro users.
  var data = (isPro && proData) ? {
    hpf: freeData.hpf,
    peq: (freeData.peq || []).concat(proData.peqExtra || []),
    peqTotal: freeData.peqTotal,
    comp: proData.comp,
    geq_stream: proData.geq_stream,
    effects: proData.effects,
    stream_tips: proData.stream_tips,
  } : freeData;
  var peqTotal = data.peqTotal || (data.peq ? data.peq.length : 0);
  var proLoading = isPro && !proData && !proError;
  ...
  return (
    <div style={{ animation:"fadein 0.4s ease" }}>
      ...
      <div style={{ display:"flex", gap:10, flexWrap:"wrap", marginBottom:20 }}>
        ...
        {isPro ? (
          ...
          <div style={{ display:"flex", alignItems:"center", gap:6, background:"rgba(255,179,71,0.1)", border:"1px solid rgba(255,179,71,0.3)", borderRadius:8, padding:"6px 14px" }}>
            <span style={{ fontSize:11, color:"#ffb347", fontFamily:"sans-serif" }}>Free preview - 2 of {peqTotal || 4} EQ bands shown</span>
          </div>
        )}
      </div>

      {proLoading && (
        <div style={{ background:"#0d1017", border:"1px solid #1a1f2e", borderRadius:12, padding:"12px 16px", marginBottom:16, fontSize:12, color:"#6b7280", fontFamily:"sans-serif" }}>Loading full cheat sheet…</div>
      )}
      {proError && (
        <div style={{ background:"rgba(255,87,87,0.08)", border:"1px solid rgba(255,87,87,0.25)", borderRadius:12, padding:"12px 16px", marginBottom:16, display:"flex", justifyContent:"space-between", alignItems:"center", gap:10, flexWrap:"wrap" }}>
          <span style={{ fontSize:12, color:"#ff5757", fontFamily:"sans-serif" }}>Couldn't load the full cheat sheet. Check your connection and retry.</span>
          <button onClick={function() { setReloadTick(function(x) { return x + 1; }); }} style={{ background:"linear-gradient(135deg,#4a7cff,#7c3aed)", color:"#fff", border:"none", borderRadius:8, padding:"7px 16px", fontSize:12, fontFamily:"sans-serif", fontWeight:700, cursor:"pointer" }}>Retry</button>
        </div>
      )}
      ...
      {data.peq && data.peq.length > 0 && (
        <div style={{ background:"#0d1017", border:"1px solid #1a1f2e", borderRadius:14, padding:"18px", marginBottom:16 }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:14 }}>
            ...
            {!isPro && <span style={{ fontSize:9, color:"#ffb347", background:"rgba(255,179,71,0.1)", borderRadius:4, padding:"2px 8px", fontFamily:"monospace" }}>{freePeqLimit} of {peqTotal} bands</span>}
          </div>
          ...
          {!isPro && (
            <div style={{ marginTop:16, background:"rgba(74,124,255,0.06)", border:"1px solid rgba(74,124,255,0.2)", borderRadius:10, padding:"14px 16px", display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:10 }}>
              <div>
                <div style={{ fontSize:12, fontWeight:700, color:"#4a7cff", fontFamily:"sans-serif", marginBottom:3 }}>🔒 {peqTotal - freePeqLimit} more EQ bands locked</div>
      ...
      {!isPro && <ProGate onUnlockClick={onUnlockClick} what="COMPRESSION SETTINGS" />}
      ...
      {!isPro && <ProGate onUnlockClick={onUnlockClick} what="STREAM MIX / GEQ TIPS" />}
      ...
      {!isPro && <ProGate onUnlockClick={onUnlockClick} what="RECOMMENDED EFFECTS CHAIN" />}
      ...
      {!isPro && <ProGate onUnlockClick={onUnlockClick} what="STREAM TIPS" />}
      ...
      {!isPro && (
        <div style={{ background:"linear-gradient(135deg,rgba(74,124,255,0.1),rgba(124,58,237,0.08))", border:"1.5px solid rgba(74,124,255,0.35)", borderRadius:16, padding:"24px", marginBottom:16, textAlign:"center" }}>
          ...
          <div style={{ fontSize:13, color:"#6b7280", fontFamily:"sans-serif", lineHeight:1.6, marginBottom:20, maxWidth:380, margin:"0 auto 20px" }}>
            You are seeing 2 of {peqTotal || 4} EQ bands. Pro unlocks full PEQ, compression, effects chain, stream tips, and PDF export for all 11 instruments.
          </div>
...
function AppCore({ user }) {
  ...
  useEffect(function() {
    ...
    (async function() {
    var token = null;
    try { token = authObj.getToken ? await authObj.getToken() : null; } catch (e) {}
    var headers = {};
    if (token) headers.Authorization = "Bearer " + token;
    fetch("/api/check-pro?userId=" + encodeURIComponent(user.id), { headers: headers })
      .then(function(r) { return r.json(); })
      .then(function(d) {
        if (d.isPro) {
